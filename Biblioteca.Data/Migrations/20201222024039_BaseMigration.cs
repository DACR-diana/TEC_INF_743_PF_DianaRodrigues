        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checkouts_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ISBN = table.Column<int>(type: "int", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Checkouts_CheckoutId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckoutBooks", x => new { x.BookId, x.CheckoutId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_ClientId",
                table: "Checkouts",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CheckoutId",
                table: "Tickets",
                column: "CheckoutId");
